export const querys = {
  ...
  getAllActivos: "SELECT EQC_id,EQC_serie,EQC_placa,EQC_EQUIP_id,EQC_MARCA_id,EQC_MAP_ciudad,EQC_MAP_provincia,EQC_MAP_address,EQC_USU_ing,EQC_fecha_ing,EQC_codTag,EQC_LOGO_id,EQC_nombreCliente,EQC_identificacionCliente,EQC_direccionCliente,EQC_NegocioCliente,EQC_telefonoCliente,EQC_cambio,EQC_estadoEquipo,EQC_observacion,EQC_TI_id,EQC_UBIC_id,EQC_provincia,EQC_cabezales,USU_nombre,EQC_SubCanal,EQC_Grupocliente,TA_descripcion AS MARCA_descripcion, TI_descripcion AS EQUIP_descripcion FROM EQUIPO_COMPLETO AS E INNER JOIN USUARIOS ON EQC_USU_ing = USU_id INNER JOIN TIPO_ACTIVO ON EQC_EQUIP_id = TA_id INNER JOIN TIPO_INVENTARIO ON EQC_TI_id = TI_id",
  getCountAllActive: "SELECT count(*) CONTEOEQUIPO FROM EQUIPO_COMPLETO",
  getActivoByUsuario: "SELECT EQC_id,EQC_serie,EQC_placa,EQC_EQUIP_id,EQC_MARCA_id,EQC_MAP_ciudad,EQC_MAP_provincia,EQC_MAP_address,EQC_USU_ing,EQC_fecha_ing,EQC_codTag,EQC_LOGO_id,EQC_nombreCliente,EQC_identificacionCliente,EQC_direccionCliente,EQC_NegocioCliente,EQC_telefonoCliente,EQC_cambio,EQC_estadoEquipo,EQC_observacion,EQC_TI_id,EQC_UBIC_id,EQC_provincia,EQC_cabezales,USU_nombre,EQC_SubCanal,EQC_Grupocliente,TA_descripcion AS MARCA_descripcion, TI_descripcion AS EQUIP_descripcion FROM EQUIPO_COMPLETO AS E INNER JOIN USUARIOS ON EQC_USU_ing = USU_id INNER JOIN TIPO_ACTIVO ON EQC_EQUIP_id = TA_id INNER JOIN TIPO_INVENTARIO ON EQC_TI_id = TI_id WHERE EQC_USU_ing = @idUsuario",  
  getActivoById: "SELECT * FROM EQUIPO_COMPLETO Where EQC_id = @Id",
  getActivoByTag: "SELECT EQC_id,EQC_serie,EQC_placa,EQC_EQUIP_id,EQC_MARCA_id,EQC_MAP_ciudad,EQC_MAP_provincia,EQC_MAP_address,EQC_USU_ing,EQC_fecha_ing,EQC_codTag,EQC_LOGO_id,EQC_nombreCliente,EQC_identificacionCliente,EQC_direccionCliente,EQC_NegocioCliente,EQC_telefonoCliente,EQC_cambio,EQC_estadoEquipo,EQC_observacion,EQC_TI_id,EQC_UBIC_id,EQC_provincia,EQC_cabezales,USU_nombre,EQC_SubCanal,EQC_Grupocliente,TA_descripcion AS MARCA_descripcion, TI_descripcion AS EQUIP_descripcion FROM EQUIPO_COMPLETO AS E INNER JOIN USUARIOS ON EQC_USU_ing = USU_id INNER JOIN TIPO_ACTIVO ON EQC_EQUIP_id = TA_id INNER JOIN TIPO_INVENTARIO ON EQC_TI_id = TI_id WHERE EQC_codTag = @EQC_codTag",
  addNewActivo:

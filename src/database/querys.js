export const querys = {
  //Querys Tabla Z_GC_EQUIPO_COMPLETO
  getAllActivos: "SELECT EQC_id,EQC_serie,EQC_placa,EQC_EQUIP_id,EQC_MARCA_id,EQC_MAP_ciudad,EQC_MAP_provincia,EQC_MAP_address,EQC_USU_ing,EQC_fecha_ing,EQC_codTag,EQC_LOGO_id,EQC_nombreCliente,EQC_identificacionCliente,EQC_direccionCliente,EQC_NegocioCliente,EQC_telefonoCliente,EQC_cambio,EQC_estadoEquipo,EQC_observacion,EQC_TI_id,EQC_UBIC_id,EQC_provincia,EQC_cabezales,USU_nombre,EQC_SubCanal,EQC_Grupocliente,TA_descripcion AS MARCA_descripcion, TI_descripcion AS EQUIP_descripcion, UBIC_ciudad,EQC_Ubicacion, EQC_image1, EQC_image2, EQC_image3 FROM Z_GC_EQUIPO_COMPLETO AS E INNER JOIN Z_GC_USUARIOS ON EQC_USU_ing = USU_id INNER JOIN Z_GC_TIPO_ACTIVO ON EQC_EQUIP_id = TA_id INNER JOIN Z_GC_TIPO_INVENTARIO ON EQC_TI_id = TI_id INNER JOIN Z_GC_UBICACION ON EQC_UBIC_id = UBIC_id",
  getCountAllActive: "SELECT count(*) CONTEOEQUIPO FROM Z_GC_EQUIPO_COMPLETO",
  getActivoByUsuario: "SELECT EQC_id,EQC_serie,EQC_placa,EQC_EQUIP_id,EQC_MARCA_id,EQC_MAP_ciudad,EQC_MAP_provincia,EQC_MAP_address,EQC_USU_ing,EQC_fecha_ing,EQC_codTag,EQC_LOGO_id,EQC_nombreCliente,EQC_identificacionCliente,EQC_direccionCliente,EQC_NegocioCliente,EQC_telefonoCliente,EQC_cambio,EQC_estadoEquipo,EQC_observacion,EQC_TI_id,EQC_UBIC_id,EQC_provincia,EQC_cabezales,USU_nombre,EQC_SubCanal,EQC_Grupocliente,TA_descripcion AS MARCA_descripcion, TI_descripcion AS EQUIP_descripcion, UBIC_ciudad,EQC_Ubicacion FROM Z_GC_EQUIPO_COMPLETO AS E INNER JOIN Z_GC_USUARIOS ON EQC_USU_ing = USU_id INNER JOIN Z_GC_TIPO_ACTIVO ON EQC_EQUIP_id = TA_id INNER JOIN Z_GC_TIPO_INVENTARIO ON EQC_TI_id = TI_id INNER JOIN Z_GC_UBICACION ON EQC_UBIC_id = UBIC_id WHERE EQC_USU_ing = @idUsuario",  
  getActivoById: "SELECT * FROM Z_GC_EQUIPO_COMPLETO Where EQC_id = @Id",
  getActivoByTag: "SELECT EQC_id,EQC_serie,EQC_placa,EQC_EQUIP_id,EQC_MARCA_id,EQC_MAP_ciudad,EQC_MAP_provincia,EQC_MAP_address,EQC_USU_ing,EQC_fecha_ing,EQC_codTag,EQC_LOGO_id,EQC_nombreCliente,EQC_identificacionCliente,EQC_direccionCliente,EQC_NegocioCliente,EQC_telefonoCliente,EQC_cambio,EQC_estadoEquipo,EQC_observacion,EQC_TI_id,EQC_UBIC_id,EQC_provincia,EQC_cabezales,USU_nombre,EQC_SubCanal,EQC_Grupocliente,TA_descripcion AS MARCA_descripcion, TI_descripcion AS EQUIP_descripcion, UBIC_ciudad,EQC_Ubicacion, EQC_image1,EQC_image2,EQC_image3 FROM Z_GC_EQUIPO_COMPLETO AS E INNER JOIN Z_GC_USUARIOS ON EQC_USU_ing = USU_id INNER JOIN Z_GC_TIPO_ACTIVO ON EQC_EQUIP_id = TA_id INNER JOIN Z_GC_TIPO_INVENTARIO ON EQC_TI_id = TI_id INNER JOIN Z_GC_UBICACION ON EQC_UBIC_id = UBIC_id WHERE EQC_codTag = @EQC_codTag",
  addNewActivo:
    "INSERT INTO Z_GC_EQUIPO_COMPLETO(EQC_serie,EQC_placa,EQC_EQUIP_id,EQC_MARCA_id,EQC_MAP_ciudad,EQC_MAP_provincia,EQC_MAP_address,EQC_USU_ing,EQC_fecha_ing,EQC_codTag,EQC_LOGO_id,EQC_nombreCliente,EQC_identificacionCliente,EQC_direccionCliente,EQC_NegocioCliente,EQC_telefonoCliente,EQC_estadoEquipo,EQC_cambio,EQC_observacion,EQC_TI_id,EQC_USU_edit,EQC_fecha_edit,EQC_UBIC_id,EQC_provincia,EQC_cabezales,EQC_SubCanal, EQC_GrupoCliente, EQC_Ubicacion, EQC_image1,EQC_image2,EQC_image3) VALUES(@EQC_serie,@EQC_placa,@EQC_EQUIP_id,@EQC_MARCA_id,@EQC_MAP_ciudad,@EQC_MAP_provincia,@EQC_MAP_address,@EQC_USU_ing,GETDATE(),@EQC_codTag,@EQC_LOGO_id,@EQC_nombreCliente,@EQC_identificacionCliente,@EQC_direccionCliente,@EQC_NegocioCliente,@EQC_telefonoCliente,@EQC_estadoEquipo,@EQC_cambio,@EQC_observacion,@EQC_TI_id,@EQC_USU_edit,GETDATE(),@EQC_UBIC_id,@EQC_provincia,@EQC_cabezales,@EQC_SubCanal, @EQC_Grupocliente,@EQC_Ubicacion,@EQC_image1,@EQC_image2,@EQC_image3)",
  deleteActivo: "DELETE FROM Z_GC_EQUIPO_COMPLETO WHERE EQC_id= @Id",
  getTotalActivos: "SELECT COUNT(*) FROM Z_GC_EQUIPO_COMPLETO",
  updateActivoById:
    "UPDATE Z_GC_EQUIPO_COMPLETO SET EQC_serie = @EQC_serie,EQC_placa = @EQC_placa,EQC_EQUIP_id = @EQC_EQUIP_id,EQC_MARCA_id = @EQC_MARCA_id,EQC_MAP_ciudad = @EQC_MAP_ciudad,EQC_MAP_provincia = @EQC_MAP_provincia,EQC_USU_edit = @EQC_USU_edit,EQC_fecha_edit = GETDATE(),EQC_codTag = @EQC_codTag,EQC_LOGO_id = @EQC_LOGO_id,EQC_nombreCliente = @EQC_nombreCliente,EQC_identificacionCliente = @EQC_identificacionCliente,EQC_direccionCliente = @EQC_direccionCliente,EQC_NegocioCliente = @EQC_NegocioCliente,EQC_telefonoCliente = @EQC_telefonoCliente,EQC_cambio = @EQC_cambio,EQC_estadoEquipo = @EQC_estadoEquipo,EQC_observacion = @EQC_observacion, EQC_TI_id = @EQC_TI_id, EQC_UBIC_id = @EQC_UBIC_id,EQC_provincia = @EQC_provincia,EQC_cabezales =@EQC_cabezales,EQC_SubCanal=@EQC_SubCanal, EQC_Grupocliente=@EQC_Grupocliente, EQC_Ubicacion = @EQC_Ubicacion, EQC_image1 = @EQC_image1,EQC_image2 = @EQC_image2,EQC_image3 = @EQC_image3  WHERE EQC_id = @Id",
    updateActivoByIdSinImagen: "UPDATE Z_GC_EQUIPO_COMPLETO SET EQC_serie = @EQC_serie,EQC_placa = @EQC_placa,EQC_EQUIP_id = @EQC_EQUIP_id,EQC_MARCA_id = @EQC_MARCA_id,EQC_MAP_ciudad = @EQC_MAP_ciudad,EQC_MAP_provincia = @EQC_MAP_provincia,EQC_USU_edit = @EQC_USU_edit,EQC_fecha_edit = GETDATE(),EQC_codTag = @EQC_codTag,EQC_LOGO_id = @EQC_LOGO_id,EQC_nombreCliente = @EQC_nombreCliente,EQC_identificacionCliente = @EQC_identificacionCliente,EQC_direccionCliente = @EQC_direccionCliente,EQC_NegocioCliente = @EQC_NegocioCliente,EQC_telefonoCliente = @EQC_telefonoCliente,EQC_cambio = @EQC_cambio,EQC_estadoEquipo = @EQC_estadoEquipo,EQC_observacion = @EQC_observacion, EQC_TI_id = @EQC_TI_id, EQC_UBIC_id = @EQC_UBIC_id,EQC_provincia = @EQC_provincia,EQC_cabezales =@EQC_cabezales,EQC_SubCanal=@EQC_SubCanal, EQC_Grupocliente=@EQC_Grupocliente, EQC_Ubicacion = @EQC_Ubicacion  WHERE EQC_id = @Id",
  //Querys Tabla Tipo Z_GC_INVENTARIO
  getAllTipoInventario: "SELECT TI_id, TI_descripcion FROM Z_GC_TIPO_INVENTARIO",

  //Querys Tabla Tipo Activo
      getAllTipoActivo: "SELECT TA_id, TA_descripcion FROM Z_GC_TIPO_ACTIVO",

   //Querys Tabla Modelos de Equipos
  getAllEquipos: "SELECT * FROM Z_GC_TIPO_ACTIVO", 
  getEquipoById: "SELECT * FROM EQUIPO Where EQ_id = @Id",
  //Querys Tabla Modelos de Usuarios
  getAllUsuarios: "SELECT * FROM Z_GC_USUARIOS", 
  getUsuarioById: "SELECT * FROM Z_GC_USUARIOS Where USU_id = @Id",
  getUserPass: "SELECT * FROM Z_GC_USUARIOS Where USU_usuario like @USU_usuario",
  //getVendedores:"SELECT AS USU_nombre FROM USUARIOS where USU_ROL like 'VENDEDOR'",
  getVendedores:"SELECT DISTINCT(EQC_identificacionCliente) AS USU_nombre FROM Z_GC_EQUIPO_COMPLETO ORDER BY EQC_identificacionCliente",
  ...
  getHistorialEquipos: "SELECT HIST_id,HIST_EQC_id,HIST_placa,HIST_serie,HIST_codTag,CONVERT(varchar,HIST_FECHA_ing,3) as HIST_FECHA_ing,HIST_USU_ing,HIST_MAP_ciudad,HIST_MAP_provincia,HIST_MAP_address,HIST_nombreCliente,HIST_identificacionCliente,HIST_direccionCliente,HIST_NegocioCliente,HIST_telefonoCliente,HIST_provincia,UBIC_ciudad,USU_nombre AS HIST_USU_nombre,HIST_estadoEquipo FROM Z_GC_HISTORIAL_MOVIMIENTOEQUIPO INNER JOIN Z_GC_USUARIOS ON HIST_USU_ing = USU_id INNER JOIN Z_GC_UBICACION ON HIST_UBIC_id = UBIC_id WHERE HIST_EQC_id = @Id",

  //Totales
  /* store procedure comentado porque este cliente no trabaja con el google maps*/
  //getDataEquiposMapa:  "SELECT T.EQC_MAP_provincia AS EQC_MAP_provincia,COUNT(DISTINCT(T.EQC_id))AS CONTEO FROM(SELECT EQC_MAP_provincia,EQC_id FROM Z_GC_EQUIPO_COMPLETO)  T GROUP BY T.EQC_MAP_provincia ",
  getDataEquiposMapa:  "SELECT T.EQC_provincia AS EQC_MAP_provincia,COUNT(DISTINCT(T.EQC_id))AS CONTEO FROM(SELECT EQC_provincia,EQC_id FROM Z_GC_EQUIPO_COMPLETO)  T GROUP BY T.EQC_provincia",
  //getDataTopFiveVendedores:"SELECT TOP 5 USU_nombre AS DESCRIPCION,count(DISTINCT(HIST_EQC_id)) AS CONTEO FROM Z_GC_HISTORIAL_MOVIMIENTOEQUIPO INNER JOIN USUARIOS ON HIST_USU_ing = USU_id WHERE HIST_id in (SELECT min(HIST_id) FROM Z_GC_HISTORIAL_MOVIMIENTOEQUIPO GROUP BY HIST_EQC_id) GROUP BY USU_nombre, HIST_USU_ing ORDER BY CONTEO DESC",
  getDataTopFiveVendedores:"SELECT USU_nombre AS DESCRIPCION,COUNT(EQC_USU_edit) AS CONTEO FROM Z_GC_EQUIPO_COMPLETO INNER JOIN Z_GC_USUARIOS ON EQC_USU_edit = USU_id GROUP BY USU_nombre, EQC_USU_edit ORDER BY CONTEO DESC",
  ...
  getTopSevenModelos: "SELECT COUNT(EQC_id) AS CONTEO, TA_descripcion AS EQUIP_modelo FROM Z_GC_EQUIPO_COMPLETO INNER JOIN Z_GC_TIPO_ACTIVO ON EQC_EQUIP_id = TA_id GROUP BY TA_descripcion ORDER BY CONTEO",
  //getTotalModelos: "SELECT T.EQUIP_modelo,COUNT(DISTINCT(T.EQC_id))AS CONTEO FROM(SELECT EQC_EQUIP_id,EQC_id,EQUIP_modelo FROM Z_GC_EQUIPO_COMPLETO INNER JOIN EQUIPO ON EQC_EQUIP_id = EQUIP_id)  T GROUP BY T.EQUIP_modelo ORDER BY CONTEO DESC",
  getTotalModelos: "SELECT COUNT(EQC_id) AS CONTEO, TA_descripcion AS EQUIP_modelo FROM Z_GC_EQUIPO_COMPLETO INNER JOIN Z_GC_TIPO_ACTIVO ON EQC_EQUIP_id = TA_id GROUP BY TA_descripcion ORDER BY CONTEO",
  ...
  //Nuevos
  getAllRoles: "SELECT * FROM Z_GC_ROL",
  getAllCargos: "SELECT * FROM Z_GC_CARGO",

  addNewUser:
    "INSERT INTO Z_GC_USUARIOS(USU_nombre,USU_usuario,USU_clave,USU_cargo,USU_rol,USU_estado,USU_conectado) VALUES(@USU_nombre,@USU_usuario,@USU_clave,@USU_cargo,@USU_rol,1,0)",
  
    updateUserById:
    "UPDATE Z_GC_USUARIOS SET USU_nombre = @USU_nombre,USU_usuario = @USU_usuario,USU_clave = @USU_clave,USU_cargo = @USU_cargo,USU_rol = @USU_rol WHERE USU_id = @Id",
    ...
    //getAllCiudad:"SELECT DISTINCT(EQC_MAP_ciudad) AS FROM Z_GC_EQUIPO_COMPLETO ORDER BY EQC_MAP_ciudad",
